...
void FingerprintDrv_Init(void)
{
  ...
  /* Fingerprint_LEDcontrol(1);
  HAL_Delay(1000);
  Fingerprint_LEDcontrol(0);
  HAL_Delay(1000);
  Fingerprint_LEDcontrol(FingerprintDrv_Enroll());
  HAL_Delay(5000);
  Fingerprint_LEDcontrol(FingerprintDrv_CheckAuth());
  HAL_Delay(5000);
  Fingerprint_LEDcontrol(FingerprintDrv_DeleteAll());
  HAL_Delay(1000); */
  }
